...
//TODO: write code to return the virtual page number for the virtual address passed in
	return NULL;
}
...
offset_t get_offset(vaddr_t virt_addr) {
	//TODO: write code to return the offset into a page for the given virtual address
   return NULL;
}
...
paddr_t create_paddr(pfn_t pfn, offset_t offset) {
	//TODO: write code to return the physical address given the two parameters
  return NULL;
}
...
paddr_t translate(vaddr_t virt_addr, int write) {
  ...
  /* TODO: Break down the virtual address into VPN and Offset */
  
  
  printf("Virtual Address %5.5hu (VPN: %5.5hu OFFSET: %5.5hu)\n",
         virt_addr, vpn, offset); /* do NOT modify this output statement */

  /* TODO: If the page table entry is not valid, raise a page fault */
  ...
  /* TODO: Update used and dirty bits */
